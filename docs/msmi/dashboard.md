...
![Hình 1](../../assets/images/invoice1/msmi_dangNhap_3.png "Hãy bấm vào để xem rõ hơn")

### Các module chức năng của phần mềm

![Hình 1](../../assets/images/invoice1/msmi_dashboard_1.png "Hãy bấm vào để xem rõ hơn")

### Tổng hợp số liệu các hóa đơn đầu ra đầu vào

![Hình 1](../../assets/images/invoice1/msmi_dashboard_2.png "Hãy bấm vào để xem rõ hơn")  
Anh chị có thể truy cập nhanh vào ký hiệu bằng cách click vào.

### Bản quyền ngày và bản quyền số lượng

![Hình 1](../../assets/images/invoice1/msmi_dashboard_3.png "Hãy bấm vào để xem rõ hơn")
