# **Điều chỉnh / Thay thế chứng từ ở năm cũ VD: chứng từ bị sai ở năm 2025**

???+ Note "Ghi chú"

    Khi sang năm mới (VD: 2026) anh chị muốn điều chỉnh hoặc thay thế chứng từ ở ký hiệu năm cũ (VD: 2025)

    Hướng dẫn này sẽ hướng dẫn Anh/Chị điều chỉnh / thay thế chứng từ ở năm cũ được xuất trên M-invoice.

    Trường hợp chứng từ cũ của anh chị được xuất bên nhà cung cấp khác vui lòng làm theo hướng dẫn sau  [Đang cập nhật hướng dẫn]

???+ Tip "Điều kiện"

    Đã tạo ký hiệu năm mới (năm 2026)

    Trường hợp anh chị chưa tạo có thể làm theo hướng dẫn sau [Hướng dẫn tạo ký hiệu theo năm tài chính](cap-nhat-ky-hieu.md#attribute-lists){ data-preview }

### **Bước 1: Truy cập vào chứng từ TNCN -> Chọn ký hiệu 2025 (CT/25E)**

![Hình 0](../../assets/images/invoice2/2.0_dieu-chinh-thay-the-tren-ky-hieu-cu_1.png "Hãy bấm vào để xem rõ hơn")

### **Bước 2: Tìm đến chứng từ sai sót -> Chọn nghiệp vụ -> Chọn Điều chỉnh hoặc Thay thế theo nhu cầu của Doanh nghiệp**
...
### **Bước 3: Sau đó Anh/Chị làm chứng từ Điều chỉnh hoặc Thay thế cho đúng**

Xem thêm các hướng dẫn điều chỉnh [Các trường hợp điều chỉnh chứng từ](../xu-ly-sai-sot/dieu-chinh-hoa-don.md#attribute-lists){ data-preview }
...
???+ Note "Căn cứ"
    ...
    Người sử dụng có thể sử dụng thao tác này để lập biên bản khi làm nghiệp vụ thay thế hay điều chỉnh chứng từ

!!! warning "Lưu ý"

    Chỉ lập được khi chứng từ ở trạng thái thay thế hoặc điều chỉnh
...
<div class="last-updated">Last updated on <strong>Jun 19, 2025</strong> by <strong>NHATTH</strong></div>
