...
=== "Thêm hóa đơn"
    ...
    **Bước 1: Truy cập vào phần lập hoá đơn**
    ...
    ![Hình 1](../../assets/images/invoice1/1.0_lap-hoa-don_1.png "Hãy bấm vào để xem rõ hơn")

    Chọn ký hiệu hóa đơn quý khách đang muốn sử dụng

    ![Hình 2](../../assets/images/invoice1/1.0_lap-hoa-don_2.png "Hãy bấm vào để xem rõ hơn")

    **Bước 2: Nhập chi tiết hoá đơn**

    Ở trên giao diện chọn **Thêm (F4)**

    ![Hình 2](../../assets/images/invoice1/1.0_lap-hoa-don_3.png "Hãy bấm vào để xem rõ hơn")

    Phần giao diện lập hóa đơn sẽ có giao diện như sau.

    ![Hình 2](../../assets/images/invoice1/1.0_lap-hoa-don_4.png "Hãy bấm vào để xem rõ hơn")

    **Phần 1**: Phần đầu phiếu hóa đơn bao gồm các thông tin

    ![Hình 2](../../assets/images/invoice1/1.0_lap-hoa-don_5.png "Hãy bấm vào để xem rõ hơn")
    ...
    ![Hình 2](../../assets/images/invoice1/1.0_lap-hoa-don_6.png "Hãy bấm vào để xem rõ hơn")
    ...
    **Đã gửi (màu đỏ)**: đã gửi lên CQT và chưa nhận được phản hồi hoặc có lỗi (Anh/Chị bấm vào chữ **Đã gửi** để xem lỗi chi tiết)
    ...
    ![Hình 8](../../assets/images/invoice1/1.0_lap-hoa-don_7.png "Hãy bấm vào để xem rõ hơn")

    Để gửi mail cho khách hàng quý khách chọn vào phần **Gửi mail hóa đơn**

    ![Hình 9](../../assets/images/invoice1/1.0_lap-hoa-don_8.png "Hãy bấm vào để xem rõ hơn")
    ...
    ![Hình 10](../../assets/images/invoice1/1.0_lap-hoa-don_9.png "Hãy bấm vào để xem rõ hơn")
...
=== "Sửa hóa đơn"
    ...
    **Bước 1: Tại màn hình danh sách hóa đơn, chọn hóa đơn chờ ký muốn sửa**
    ...
    ![Hình 1](../../assets/images/invoice1/1.0_sua-hoa-don_1.png "Hãy bấm vào để xem rõ hơn")

    **Bước 2: Click button "Sửa"**

    ![Hình 2](../../assets/images/invoice1/1.0_sua-hoa-don_2.png "Hãy bấm vào để xem rõ hơn")

    **Bước 3: Sửa nội dung hóa đơn và click "Lưu" để lưu lại thông tin**

    ![Hình 3](../../assets/images/invoice1/1.0_sua-hoa-don_3.png "Hãy bấm vào để xem rõ hơn")
...
=== "Xoá hóa đơn"
    ...
    **Bước 1: Tại màn hình danh sách hóa đơn, chọn hóa đơn Chờ ký muốn xóa**
    ...
    ![Hình 1](../../assets/images/invoice1/1.0_xoa-hoa-don_1.png "Hãy bấm vào để xem rõ hơn")

    <p align = "center">Đối với hình thức Sinh số sau, NSD sẽ không xóa được các hóa đơn ở giữa như hình vẽ.</p>

    ![Hình 2](../../assets/images/invoice1/1.0_xoa-hoa-don_2.png "Hãy bấm vào để xem rõ hơn")

    <p align = "center">Thường hợp muốn xoá nhiều</p>

    **Bước 2: Click button "Xóa (F8)" hoặc nhấn phím chức năng F8.**

    ![Hình 3](../../assets/images/invoice1/1.0_xoa-hoa-don_3.png "Hãy bấm vào để xem rõ hơn")
...
=== "Sao chép hóa đơn"
    ...
    **Bước 1: Chọn hóa đơn muốn dùng làm mẫu**
    ...
    ![Hình 1](../../assets/images/invoice1/1.0_sao-chep-hoa-don_1.png "Hãy bấm vào để xem rõ hơn")

    **Bước 2: Click button "Sao chép"**

    ![Hình 2](../../assets/images/invoice1/1.0_sao-chep-hoa-don_2.png "Hãy bấm vào để xem rõ hơn")
    ...
    **Bước 3: Kiểm tra và chỉnh sửa nội dung hóa đơn được tạo ra**
    ...
    ![Hình 3](../../assets/images/invoice1/1.0_sao-chep-hoa-don_3.png "Hãy bấm vào để xem rõ hơn")
...
<div class="last-updated">Last updated on <strong>Feb 05, 2025</strong> by <strong>NHATTH</strong></div>
