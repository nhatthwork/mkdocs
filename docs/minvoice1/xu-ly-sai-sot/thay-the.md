...
![Hình 1](../../assets/images/invoice1/1.0_thayThe_1.png "Hãy bấm vào để xem rõ hơn")

### **Bước 2: Điền lại phần chi tiết hóa đơn như 1 tờ hóa đơn mới**

![Hình 2](../../assets/images/invoice1/1.0_thayThe_2.png "Hãy bấm vào để xem rõ hơn")

Nếu hóa đơn có nhiều dòng hàng hóa, bạn cũng có thể cọn copy dòng hàng hóa cũ sang bằng cách nhấn vào Chọn hàng hóa

![Hình 3](../../assets/images/invoice1/1.0_thayThe_3.png "Hãy bấm vào để xem rõ hơn")

### **Bước 3 : Sau khi nhập xong bạn tiến hành lưu lại và ký gửi CQT 1 cách bình thường**

![Hình 4](../../assets/images/invoice1/1.0_thayThe_4.png "Hãy bấm vào để xem rõ hơn")
