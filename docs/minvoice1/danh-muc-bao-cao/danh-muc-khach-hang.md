...
=== "Cách 1: Nhập thủ công từ Danh mục - Khách hàng"
    ...
    **Trên giao diện trang chủ truy cập Danh mục --> khách hàng**
    ...
    ![Hình 1](../../assets/images/invoice1/1.0_danh-muc-khach-hang_1.png "Hãy bấm vào để xem rõ hơn")

    Bạn nhấn nút **Thêm(F4)** để bắt đầu thêm Khách hàng
    Nhập đầy đủ thông tin như **Mã đối tượng, mã số thuế, Tên đơn vị, Địa chỉ ....**
    Khi nhập xong bạn nhấn Lưu để lưu hàng mã đối tượng khách hàng này vào

    ![Hình 2](../../assets/images/invoice1/1.0_danh-muc-khach-hang_2.png "Hãy bấm vào để xem rõ hơn")
...
=== "Cách 2: Nhập thủ công khi lập hóa đơn"
    ...
    ![Hình 3](../../assets/images/invoice1/1.0_danh-muc-khach-hang_3.png "Hãy bấm vào để xem rõ hơn")
    ...
    ![Hình 3](../../assets/images/invoice1/1.0_danh-muc-khach-hang_4.png "Hãy bấm vào để xem rõ hơn")
...
=== "Cách 3: Nhập từ file excel"
    ...
    **Trên giao diện trang chủ truy cập Danh mục --> khách hàng**
    ...
    ![Hình 4](../../assets/images/invoice1/1.0_danh-muc-khach-hang_5.png "Hãy bấm vào để xem rõ hơn")

    ![Hình 5](../../assets/images/invoice1/1.0_danh-muc-khach-hang_6.png "Hãy bấm vào để xem rõ hơn")

    Nhập đầy đủ thông tin bạn muốn tải lên vào file mẫu sau đó lưu lại (Những mục có dấu * là bắt buộc)

    ![Hình 6](../../assets/images/invoice1/1.0_danh-muc-khach-hang_7.png "Hãy bấm vào để xem rõ hơn")
...
=== "Kết xuất Excel danh mục khách hàng"
    ...
    **Mục đích:** Tải excel danh mục khách hàng về để lưu trữ hoặc phân tích
    ...
    ![Hình 5](../../assets/images/invoice1/1.0_danh-muc-khach-hang_8.png "Hãy bấm vào để xem rõ hơn")
...
<div class="last-updated">Last updated on <strong>Mar 16, 2026</strong> by <strong>NHATTH</strong></div>
