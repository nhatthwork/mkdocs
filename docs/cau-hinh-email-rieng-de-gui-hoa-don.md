...
???+ Note "Mục đích"
    ...
    <p style="color:red;">
    <strong>Lưu ý:</strong> Khi gửi email bằng hình thức email tự cấu hình, hệ thống M-invoice sẽ không kiểm tra được trạng thái email đã được gửi hay chưa trên giao diện. 
    Việc xác nhận email gửi thành công sẽ hoàn toàn dựa trên hệ thống email của quý đơn vị.
    </p>
...
![Hình 1](../../assets/images/invoice2/2.0_cau-hinh-gmail_1.png "Hãy bấm vào để xem rõ hơn")

#### 3. Tìm kiếm mật khẩu ứng dụng (Để tạo mật khẩu ứng dụng)

![Hình 1](../../assets/images/invoice2/2.0_cau-hinh-gmail_2.png "Hãy bấm vào để xem rõ hơn")

Điền tên ứng dụng để tạo (Điền tên dễ nhớ bất kỳ)

![Hình 1](../../assets/images/invoice2/2.0_cau-hinh-gmail_3.png "Hãy bấm vào để xem rõ hơn")

Copy đoạn mật khẩu ứng dụng đã được tạo -> nhấn **Xong**

![Hình 1](../../assets/images/invoice2/2.0_cau-hinh-gmail_4.png "Hãy bấm vào để xem rõ hơn")

### **Bước 2: [Thao tác ở phần mềm hóa đơn điện tử M-invoice] truy cập Hệ thống - Cấu hình email server**

![Hình 1](../../assets/images/invoice2/2.0_cau-hinh-gmail_5.png "Hãy bấm vào để xem rõ hơn")

Bấm **Thêm**

![Hình 1](../../assets/images/invoice2/2.0_cau-hinh-gmail_6.png "Hãy bấm vào để xem rõ hơn")

Điền các thông tin

![Hình 1](../../assets/images/invoice2/2.0_cau-hinh-gmail_7.png "Hãy bấm vào để xem rõ hơn")
